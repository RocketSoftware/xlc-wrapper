...
#define option_has_argument(opt) (opt=='D'||opt=='L'||opt=='I'||opt=='l'||opt=='o'||opt=='F'||opt=='u')
...
/*
© 2016-2018 Rocket Software, Inc. or its ffiliates. All Rights Reserved.
ROCKET SOFTWARE, INC. 
*/
